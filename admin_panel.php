...
.container-fluid {
    height: 70vh; /* Makes the container take up the full viewport height */
...
h1 {
    font-size: 5rem; /* Adjust the size of the text */
    ...
    <div id="wrapper">
        ...
        <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
            ...
            <li class="nav-item">
                <a class="nav-link" href="add_package.php">
                    <i class="fas fa-fw fa-table"></i>
                    <span>Add Packages</span></a>
            </li>

            <li class="nav-item">
                <a class="nav-link" href="manage_packages.php">
                    <i class="fas fa-fw fa-table"></i>
                    <span>Manage Packeges</span></a>
            </li>

            <li class="nav-item">
                <a class="nav-link" href="admin_checkout.php">
                    <i class="fas fa-fw fa-table"></i>
                    <span>View Checkouts</span></a>
            </li>

            <li class="nav-item">
                <a class="nav-link" href="admin_payment_history.php">
                    <i class="fas fa-fw fa-table"></i>
                    <span>Booking Payment History</span></a>
            </li>

            <li class="nav-item">
                <a class="nav-link" href="admin_flights.php">
                    <i class="fas fa-fw fa-table"></i>
                    <span>Manage Flights</span></a>
            </li>
        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <h1 class="display-4 text-center text-primary">Sky Travels Admins</h1>
